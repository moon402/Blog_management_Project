...
const getData = async function (req, res) {
    try {
        ...
        if (Object.keys(req.query).length > 0) {
            ...
            res.status(200).send({ status: true, data: savedata2 })
        }
...
const updateBlog = async function (req, res) {
    try {
        ...
        if (!isValidBlogId) {
            ...
            res.status(200).send({ status: true, data: updateBlog , message: "updated"})
        }
    } catch (err) {
...
const DELETEdata = async function (req, res) {
    try {
        ...
        res.status(200).send({ status: true,message: "Blog deletion is successful"})
    } catch (err) {
